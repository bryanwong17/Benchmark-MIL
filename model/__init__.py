...
def get_model_module(args, seed, mil_model, num_feats, num_classes, loss_weight=None):
    ...
    if mil_model == "DTFD-MIL":
        ...
        trainer_module = DTFDTrainerModule(args, seed, classifier_model, loss, get_metrics(num_classes, task))
    else:
        trainer_module = MILTrainerModule(args, seed, classifier_model, loss, get_metrics(num_classes, task), num_classes, forward_func=forward_func)
